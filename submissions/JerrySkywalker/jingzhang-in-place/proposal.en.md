...
![Site state, evidence tiers, and three-level scope](assets/figures/site-overview.en.png)
...
- **Class III Long-Horizon Interface (> 3.0M RMB, conditional planning interface)**: Grade-separated crossings and underground transit links designated as `CONDITIONAL_LONG_HORIZON_INTERFACE` (long-horizon conditional planning interfaces), advancing only upon formal public capital approvals and not part of immediate works.
